 ...
 * PackageName: com.sg.sgyfb.common.page
 * Created by lizhe on 2016/10/18.
 */
public class AjaxPagination extends SimplePage{
    private List<?> list;
...
/*     */   }
    /*     */
/*     */   public AjaxPagination(int pageNo, int pageSize, int totalCount)
/*     */   {
/*  25 */     super(pageNo, pageSize, totalCount);
/*     */   }
    /*     */
/*     */   public AjaxPagination(int pageNo, int pageSize, int totalCount, List<?> list)
/*     */   {
...
/* 109 */       this.pageView.add("<li class='paginItem'><a href=\" "+ url + "?" + params + "&pageNo=1\">首页</a></li>");
/* 110 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (this.pageNo - 1) + "\">上页</a></li>");
/*     */     } else {
...
/*     */         }
/* 123 */         this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (i + 1) + "\" >" + (i + 1) + "</a></li>");
/*     */       }
...
/*     */         }
/* 146 */         this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + i + "\" >" + i + "</a></li>");
/*     */       }
/*     */     }
...
/* 153 */           i++;
/*     */         }
/* 155 */         this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (i + 1) + "\" >" + (i + 1) + "</a></li>");
/*     */       }
/* 157 */       this.pageView.add("<li class='paginItem more'><a href='javascript:;'>...</a></li>");
/* 158 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (getTotalPage() - 1) + "\" >" + (getTotalPage() - 1) + "</a></li>");
/* 159 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + getTotalPage() + "\" >" + getTotalPage() + "</a></li>");
/* 160 */     } else if (this.pageNo > getTotalPage() - 6) {
/* 161 */       this.pageView.add("<a href=\"" + url + "?" + params + "&pageNo=" + 1 + "\" >" + 1 + "</a>");
/* 162 */       this.pageView.add("<a href=\"" + url + "?" + params + "&pageNo=" + 2 + "\" >" + 2 + "</a>");
...
/*     */         }
/* 170 */         this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (i + 1) + "\" >" + (i + 1) + "</a></li>");
/*     */       }
/*     */     } else {
/* 173 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + 1 + "\" >" + 1 + "</a></li>");
/* 174 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + 2 + "\">" + 2 + "</a></li>");
/* 175 */       this.pageView.add("<li class='paginItem more'><a href='javascript:;'>...</a></li>");
/*     */
/* 177 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (this.pageNo - 2) + "\" >" + (this.pageNo - 2) + "</a></li>");
/* 178 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (this.pageNo - 1) + "\" >" + (this.pageNo - 1) + "</a></li>");
/* 179 */       this.pageView.add("<li class='paginItem current'>" + this.pageNo + "</li>");
/* 180 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (this.pageNo + 1) + "\" >" + (this.pageNo + 1) + "</a></li>");
/* 181 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (this.pageNo + 2) + "\" >" + (this.pageNo + 2) + "</a></li>");
/*     */
/* 183 */       this.pageView.add("<li class='paginItem more'><a href='javascript:;'>...</a></li>");
/* 184 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (getTotalPage() - 1) + "\" >" + (getTotalPage() - 1) + "</a></li>");
/* 185 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + getTotalPage() + "\" >" + getTotalPage() + "</a></li>");
/*     */     }
/* 187 */     if (this.pageNo != getTotalPage()) {
/* 188 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + (this.pageNo + 1) + "\" ><font size=2>下页</font></a></li>");
/* 189 */       this.pageView.add("<li class='paginItem'><a href=\"" + url + "?" + params + "&pageNo=" + getTotalPage() + "\" ><font size=2>尾页</font></a></li>");
/*     */     } else {
